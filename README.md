> **reMarkable 1 port:** This checkout has been ported to RM1/ARMv7. Start with [README-RM1.md](README-RM1.md). The older text below describes the original Paper Pro version and is retained as project background.
